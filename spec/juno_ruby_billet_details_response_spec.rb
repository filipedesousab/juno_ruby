...
RSpec.describe "JunoRuby BilletDetailsResponse" do
  it "must accept only string in bank_account" do
    ...
    expect { billet_details_response.bank_account = 10 }.to raise_error(JunoRuby::Errors::TypeError)
  end
  ...
  it "must accept only string in our_number" do
    ...
    expect { billet_details_response.our_number = 10 }.to raise_error(JunoRuby::Errors::TypeError)
  end
  ...
  it "must accept only string in barcode_number" do
    ...
    expect { billet_details_response.barcode_number = 10 }.to raise_error(JunoRuby::Errors::TypeError)
  end
  ...
  it "must accept only string in portfolio" do
    ...
    expect { billet_details_response.portfolio = 10 }.to raise_error(JunoRuby::Errors::TypeError)
  end
end
